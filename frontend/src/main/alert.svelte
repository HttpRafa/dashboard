...
<div role="status" aria-live="polite" class="flex justify-center w-full mb-4">
    ...
    >
        <span
            class="w-5 h-5 text-blue-200 flex-none material-symbols-outlined align-middle"
            >cloud_alert</span
        >
        ...
        <p class="text-sm leading-tight text-blue-50">
            ...
            <span class="ml-2 text-blue-50"
                >Scheduled maintenace on Gameserver Infrastructure on Saturday
                at 10:00 AM UTC. Expect brief downtime</span
            >
        </p>
    </div>
</div>
