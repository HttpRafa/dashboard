...
<div class="p-4 sm:p-6 lg:p-8">
    ...
    <header>
        ...
        <div class="flex justify-between items-center mb-4">
            <button
                class="bg-emerald-500/65 hover:bg-emerald-700/65 text-white font-semibold py-2 px-6 rounded-lg transition cursor-pointer"
            >
                Submit feedback
            </button>
            <button
    ...
    <div class="space-y-3">
        ...
        >
            <div class="col-span-12 md:col-span-5">Topic</div>
            <div class="col-span-12 md:col-span-3">Scope</div>
